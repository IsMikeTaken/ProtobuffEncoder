...
public static class HttpClientExtensions
{
    ...
    /// </summary>
    public static async Task<TResponse> PostProtobufAsync<TRequest, TResponse>(this HttpClient client, string requestUri, TRequest request, CancellationToken cancellationToken = default) where TResponse : new()
    {
    ...
    /// </summary>
    public static async Task<HttpResponseMessage> PostProtobufAsync<TRequest>(this HttpClient client, string requestUri, TRequest request, CancellationToken cancellationToken = default)
    {
        using var content = new ProtobufHttpContent(request!);
        using var httpRequest = new HttpRequestMessage(HttpMethod.Post, requestUri);
        httpRequest.Content = content;
    ...
    /// </summary>
    public static async Task<T> GetProtobufAsync<T>(this HttpClient client, string requestUri, CancellationToken cancellationToken = default) where T : new()
    {
